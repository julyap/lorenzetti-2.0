...
def build_argparser():
    ...
    parser.add_argument('--zero-vertex-particles', action='store_true', dest='zero_vertex_particles', required=False,
                        help="Fix the z vertex position in simulation to zero for all selected particles.")
...
def run(args):
    ...
    try:
        ...
        main_file = os.environ['LZT_PATH'] + '/generator/evtgen/data/JPsi_config.cmnd'
        ...
        jpsi = Jpsi("Jpsi", 
                    ...
                    EtaMax=args.eta_max,
                    MinPt=15 * GeV,
                    ZeroVertexParticles=args.zero_vertex_particles,
